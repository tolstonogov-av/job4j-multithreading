...
Количество нитей всегда одинаковое и равно size. В каждую нить передается блокирующая очередь tasks. В методе run мы должны получить задачу из очереди tasks.
